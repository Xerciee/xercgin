                            ...
                            <div class="x_content">
                                <div class="box">
                                  ...
                                  where ebook_id='$ID'") or die(mysqli_error($con));
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-4" for="up_file">Upload File
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="file" name="up_file" accept=".pdf"
                                                        value="<?php echo htmlspecialchars($row['up_file']); ?>"
                                                        id="upload" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            <div class="ln_solid"></div>
                                            <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                    <a href="ebooks_search.php"><button type="button"
                                        ...
                                        if (isset($_POST['update11'])) {
                                            ...
                                            if (!empty($_FILES['up_file']['tmp_name'])) {
                                                $up_file = $_FILES['up_file']['tmp_name'];
                                                $file_name = rand(1000, 10000) . "_" . $_FILES['up_file']['name'];
...
date_of_publ='$date_of_publ', series='$series', isbn_no='$isbn_no', accession_no='$accession_no', moa_id='$moa_id', issn_no='$issn_no', notation1='$notation1', notation2='$notation2', abstract='$abstract', remarks='$remark',page_no='$page_no' WHERE ebook_id = '$id' ") or die(mysqli_error($con));
                                                ...
                                                unlink("../ebooks/" . $row['up_file']);
                                                mysqli_query($con, " UPDATE ebooks SET call_no='$call_no',title='$title', subject='$subject', author='$author', editor='$editor', edition='$edition', pop_id='$pop_id', publisher_id='$publisher_id', quantity='$quantity', 
date_of_publ='$date_of_publ', series='$series', isbn_no='$isbn_no', accession_no='$accession_no', moa_id='$moa_id', issn_no='$issn_no', notation1='$notation1', notation2='$notation2', abstract='$abstract', remarks='$remark',page_no='$page_no',up_file='$file_name' WHERE ebook_id = '$id' ") or die(mysqli_error($con));
                                            }
