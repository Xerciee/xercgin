                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                LEFT JOIN tbl_moa ON tbl_moa.moa_id = ebooks.moa_id ORDER BY ebook_id") or die(mysqli_error($con));
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <!--- either this <td><a target="_blank" href="view_book_barcode.php?code=<?php // echo $row['ebook_barcode']; 
                                                                                                                                            ?>"><?php // echo $row['ebook_barcode']; 
                                                                                                                                                ?></a></td> -->
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" for="ViewAdmin"
                                                                href="view_ebooks.php<?php echo '?ebook_id=' . $id; ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
